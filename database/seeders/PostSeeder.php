...
class PostSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $posts = [
            [
                'title' => "Selamat Datang di Website Resmi Pondok Pesantren Qurrota A'yun",
                'slug' => 'selamat-datang-di-website-resmi-pondok-pesantren-qurrota-ayun',
                'excerpt' => "Website resmi Pondok Pesantren Qurrota A'yun kini hadir untuk memudahkan akses informasi seputar program pendidikan, kegiatan, penerimaan santri baru, dan kisah inspiratif dari pesantren.",
                'content' => "<p>Bismillahirrahmanirrahim. Selamat datang di website resmi Pondok Pesantren Qurrota A'yun! Kami dengan bangga mempersembahkan portal informasi digital yang dirancang untuk memudahkan seluruh warga pesantren, wali santri, dan masyarakat luas dalam mengakses berbagai informasi penting.</p><h2>Fitur Unggulan Website</h2><p>Melalui website ini, Anda dapat menemukan berbagai informasi meliputi profil dan visi-misi pesantren, program pendidikan tahfidz dan diniyah, kegiatan dan agenda pesantren, kisah inspiratif santri, toko buku pesantren, serta formulir pendaftaran santri baru secara online.</p><p>Kami berkomitmen untuk terus memperbarui konten website ini agar selalu relevan dan informatif. Jangan ragu untuk menghubungi kami jika ada pertanyaan atau masukan. Jazakumullah khairan.</p>",
                'category' => 'Berita',
                'author' => 'Tim Humas',
                'author_initials' => 'TH',
                'read_time' => 2,
